@AbapCatalog.sqlViewName: 'ZMGUNES_5053_V02'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'CDS Ödev 2-1'
define view ZMGUNES_5053_CDS_002
  as select from    vbrp
                         ...
                         and makt.spras = $session.system_language
{
  ...
  key vbrp.posnr,
      ...
      case vbrk.fkart when 'FAS' then 'Peşinat talebi iptali'
                      when 'FAZ' then 'Peşinat talebi' else 'Fatura' end as faturalama_turu,
      vbrk.fkdat
}
